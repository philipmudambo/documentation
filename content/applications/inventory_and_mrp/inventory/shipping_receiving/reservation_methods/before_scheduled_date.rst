...
:guilabel:`Add a product`, and select a product, with a configured *customer lead time*, to add to
the quotation from the drop-down menu.
...
Since reservation isn't until two days before the scheduled delivery, it will not reserve the
products until then.
