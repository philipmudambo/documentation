...
The liquidity product direct sale is used, for example, in the cases where sales are made by 
the order of a third-party.

For these cases, the seller and the proprietary company of the goods, will be able to register 
their corresponding sales and purchase. 

This feature is included when installing the Argentinian EDI module (l10n_ar_edi). To install 
or update this module, go to :guidable:’Apps > Remove filters > Search ‘l10n_ar_edi’’.

.. image:: ecuador/l10n_ar_edi.png
   :align: center 
   :alt: l10n_ar EDI Module

.. note::
	The Argentinian EDI module is dependent on the previous installation of the Invoicing or 
Accounting Apps and the Argentinian base module (l10n_ar).
...
This feature includes the addition of the following document types: ‘23', '24', '25', '26', 
'27', '28', '33', '43', '45', '46', '48', '58', '60', '61', ‘150', '151', '157', '158', '161', 
'162', '164', '166', '167', '171', '172', '180', '182', '186', '188', '332'.

It is important to note that by default these document types are inactive. For the workflow 
to work, it is necessary to activate these documents. To find these documents, remove all filters 
in the menu ‘Tipo de Documentos’ and activate them by toggling the option ‘Active’.

.. image:: ecuador/l10n_ar_document_types.png
   :align: center 
   :alt: l10n_ar Document Types

Purchase Journal
****************

A purchase journal is needed to generate an electronic vendor bill with a document type ‘Liquidity Product’ 
for the order for “company A”. This journal will have to have the sync with AFIP active as this electronic 
document will be sent to the AFIP.

.. image:: ecuador/l10n_ar_purchase_journal.png
   :align: center 
...
A sales journal will be needed to register the invoice when the owner of a product sells its good to the third 
party that then will sell this. This journal will not have any sync with AFIP as the invoice will not be electronic.

.. image:: ecuador/l10n_ar_sales_journal.png
   :align: center 
   :alt: l10n_ar Sales Journal Configuration

Invoicing Flow for Liquidity Products
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

When the configurations are all set, this feature will cover the next invoicing flow:

guilable:’Liquidity Product Vendor Bill’: This electronic document will be generated by the company that is 
selling the product on behalf of another party. For example, a ‘Distributor’ of a specific product.

.. image:: ecuador/l10n_ar_liquidity_product_electronic_document.png
   :align: center 
   :alt: l10n_ar Liquidity Product Document
